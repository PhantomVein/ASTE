...
def load_pytorch_weights_in_tf2_model(tf_model, pt_state_dict, tf_inputs=None, allow_missing_keys=False):
    ...
    # Make sure we are able to load PyTorch base modules as well as derived modules (with heads)
    # TF modules always have a prefix, some of PyTorch modules (base ones) don't
