...
class TFPreTrainedModel(tf.keras.Model):
    r""" Base class for all TF modules.

        :class:`~transformers.TFPreTrainedModel` takes care of storing the configuration of the modules and handles methods for loading/downloading/saving modules
        as well as a few methods commons to all modules to (i) resize the input embeddings and (ii) prune heads in the self-attention heads.
