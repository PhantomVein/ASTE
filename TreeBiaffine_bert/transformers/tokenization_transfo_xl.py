...
PRETRAINED_VOCAB_FILES_MAP = {
    ...
    {
        'transfo-xl-wt103': "https://s3.amazonaws.com/modules.huggingface.co/bert/transfo-xl-wt103-vocab.bin",
    }
}
...
PRETRAINED_CORPUS_ARCHIVE_MAP = {
    'transfo-xl-wt103': "https://s3.amazonaws.com/modules.huggingface.co/bert/transfo-xl-wt103-corpus.bin",
}
...
class TransfoXLTokenizer(PreTrainedTokenizer):
    ...
    def _convert_token_to_id(self, sym):
        ...
        if sym in self.sym2idx:
            ...
            # Backward compatibility with pre-trained modules
            elif '<unk>' in self.sym2idx:
